<template>
  <div class="slider-container" ref='slider'
    ...
    <div class="slider-content" :class="mask ? 'mask' : ''">
      <div class="slider" v-for="(item, index) in bannerList"
           :key="index"
...
<!--      <i v-show="arrow" class="iconfont icon-right" @click="next()"></i>-->
    ...
    <div class="dots" v-if="dots">
      <span v-for="(item, index) in bannerList" :key="item"
...
<script>
    export default {
      ...
      methods: {
        setClass (i) {
          let next = this.currentIndex === (this.bannerList.length - 1) ? 0 : this.currentIndex + 1;
          let prev = this.currentIndex === 0 ? this.bannerList.length - 1 : this.currentIndex - 1;
          switch (i) {
